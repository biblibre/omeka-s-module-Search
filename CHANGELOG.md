...
- Related resources are also marked for reindexation. For instance if a media
  is modified, its item is also marked for reindexation

## [0.23.1] - 2026-07-10

  - Improve facet filtering display
  - Update translations

## [0.23.0] - 2026-07-10

- Improve OR operator on facets :
  - Add view helper for OR operator
  - Better display and selection

## [0.22.0] - 2026-06-23

- Add OR operator on facets
...
- Add `has_media` filter support from Solr to search items with or without media.
